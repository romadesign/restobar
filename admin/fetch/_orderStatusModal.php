  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111 202 203);">
        <h5 class="modal-title" id="orderStatus<?php echo $orderid; ?>">Estado del pedido y detalles de entrega</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="fetch/_orderManage.php" method="post" style="border-bottom: 2px solid #dee2e6;">
        ...
        ?>
            <form action="fetch/_orderManage.php" method="post">
                <div class="text-left my-2">
